...
class TaskExecuteInfo(models.Model):
    ...
    failure = models.TextField(null=True, blank=True, verbose_name="失败原因")
    error = models.TextField(null=True, blank=True, verbose_name="错误原因")
    exec_time = models.IntegerField(null=True, blank=True, verbose_name="执行时长")
